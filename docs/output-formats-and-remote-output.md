...
- `./embedded_linux_audit --insecure --output-https <https://host:port/path> uboot env` disables TLS certificate and hostname verification for HTTPS output.
...
- `./embedded_linux_audit --insecure --output-https <https://host:port/path> uboot image ...` disables TLS certificate and hostname verification for HTTPS output.
...
- `./embedded_linux_audit --insecure --output-https <https://host:port/path> efi orom pull`
- `./embedded_linux_audit --insecure --output-https <https://host:port/path> bios orom pull`
