...
|---|---|---|
| `/gdb/in/<32-hex-key>` | embedded agent | Agent connects here; sends RSP frames from gdbserver |
| `/gdb/out/<32-hex-key>` | `gdb-multiarch` | Analyst's GDB connects here; receives/sends RSP frames |
...
See [gdbserver tunnel](../agent/linux/gdbserver.md#embedded_linux_audit-linux-gdbserver-tunnel-subcommand)
