...
- HTTPS POST (`--output-https`, passed as a top-level option)
...
./embedded_linux_audit --insecure --output-https https://192.168.1.50:5443 linux remote-copy /tmp/fw.bin
./embedded_linux_audit --quiet --insecure --output-https https://192.168.1.50:5443 linux remote-copy /tmp/fw.bin
