...
run_curl_body_contains_case "GET / includes test scripts" GET "$TEST_WEB_BASE_URL/" 200 "tests/test_one.sh"
run_curl_case "GET /tests/test_one.sh" GET "$TEST_WEB_BASE_URL/tests/test_one.sh" 200 "$SCRIPT_BODY"
run_curl_case "GET /tests/..%2Fescape rejects invalid segment" GET "$TEST_WEB_BASE_URL/tests/..%2Fescape" 400 "invalid path"
run_curl_case "GET /tests/missing.sh returns 404" GET "$TEST_WEB_BASE_URL/tests/missing.sh" 404 "not found"
run_curl_case "GET /tests/not_a_file returns 404" GET "$TEST_WEB_BASE_URL/tests/not_a_file" 404 "not found"
