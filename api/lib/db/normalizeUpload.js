...
function normalizeUpload(input) {
  ...
  } else if (['log', 'logs', 'dmesg', 'linux-audit', 'orom', 'coredump', 'tpm2-getcap', 'tpm2-pcrread', 'tpm2-nvreadpublic', 'tpm2-createprimary', 'uboot-image', 'uboot-environment'].includes(input.uploadType)) {
