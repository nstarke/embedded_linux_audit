...
| `linux wlan fuzz` | Class-directed firmware fuzzer for WLAN NIC command interfaces (USB dongles via usbfs; `ath10k`/`ath11k`/`ath12k`/`mt76`/`brcmfmac` PCIe/SDIO via the `ela_kmod` kernel shim). See [docs](docs/agent/linux/wlan-fuzz.md) |
